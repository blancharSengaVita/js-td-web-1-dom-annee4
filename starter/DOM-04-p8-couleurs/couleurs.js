...
const couleurTexte = prompt('donner la couleur du texte son nom anglais ou bien en utilisant le format hexadécimal ou RGB');
const couleurDeFond = prompt('donner moi la couleur du texte son nom anglais ou bien en utilisant le format hexadécimal ou RGB');

document.body.style.backgroundColor = couleurTexte;
document.body.style.color = couleurDeFond;