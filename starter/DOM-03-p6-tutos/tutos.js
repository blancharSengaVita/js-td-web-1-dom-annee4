...
const tuto1 = new Tuto('Apprenez à coder avec JavaScript','https://openclassrooms.com/fr/courses/2984401-apprenez-a-coder-avec-javascript', 'openclassroom');

const tuto2 = new Tuto('Créez des pages web interactives avec JavaScript','https://openclassrooms.com/fr/courses/3306901-creez-des-pages-web-interactives-avec-javascript/', 'openclassroom');

const tuto3 = new Tuto('The Complete JavaScript Course 2019 : Build Real Projects! sur UDEMY','https://www.udemy.com/course/the-complete-javascript-course/', 'udemy');
