...
// console.log(ulElt);
// ulElt.innerHTML += "<li id=\"php\"> C </li>";
// ulElt.innerHTML = "";
...
// titre.textContent += " de programmation";
// console.log(titre)
...
// const liELT = document.querySelectorAll('li').item(0);
...
newElt.textContent = "CSS"
newElt.id = "CSS"

ulElt.replaceChild(newElt, document.querySelector('#csharp'));
