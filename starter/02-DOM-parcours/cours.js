...
console.log(merveilles);
Array.from(merveilles).forEach(element => console.log(element));
...
*/
const nouvelles = document.getElementById('nouvelles');
...
console.log(Array.from(document.getElementById("antiques").getElementsByClassName("existe"))[0]);
...
// Le premier (et seul) enfant de l'élément d'id "antiques" ayant la classe "existe"
console.log(document.querySelector('p:first-child, #antiques, .existe'));
...
console.log(document.querySelector("#antiques").classList[0]);

// Teste si l'élément d'id "antiques" possède la classe "merveille"
console.log(document.querySelector("#antiques").classList.contains("merveilles"));
